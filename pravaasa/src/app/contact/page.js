...
const Contact = () => {
  return (
    <div className="relative min-h-screen bg-white">
      <header
        className="relative w-full h-48 sm:h-72 lg:h-96 overflow-hidden bg-cover bg-center bg-no-repeat mb-12"
        style={{ backgroundImage: "url('/images/contact.jpg')" }}
      >
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 mt-6 md:mt-12 lg:mt-16">
          <h1 className="text-white text-lg md:text-4xl font-bold">
            <span className="text-3xl md:text-6xl">Contact</span>
            <br />
      ...
      <section className="relative  sm:pt-12 px-4 flex flex-col items-center gap-8 z-20">
      ...
      {/* Main content */}
      <main className="py-8 px-4 mt-16 sm:mt-20 lg:mt-24">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            {/* Contact Information */}
            <div
              className="w-full lg:w-1/2 bg-gray-100 rounded-lg shadow-md"
              style={{
            ...
            >
              <h3 className="text-xl lg:text-4xl text-white font-bold mb-4">
                Contact Information
              </h3>
              <address className="text-gray-700 text-white">
                <p className="mb-2">
                  Address: Vill. Dhangvi Post Office.
                  <br /> Kokunala, Dhangwi Kalan (145), <br /> Shimla, Himachal
                  Pradesh, 171202
                </p>
                <p className="mb-2">
                  Phone:{" "}
